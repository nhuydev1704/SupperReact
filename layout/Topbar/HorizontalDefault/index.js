...
import UserInfo from '../../../componentUis/UserInfo';
            ...
            <ul className="gx-sub-popover">
                {languageData.map((language) => (
                    <li
                        ...
                        // onClick={(e) => switchLanguage(language)}
                    >
            ...
            <Header className="gx-header-horizontal-main">
                <div className="gx-container">
                    <div className="gx-header-horizontal-main-flex">
                        ...
                        <Link passHref href="/" className="gx-d-block gx-d-lg-none gx-pointer gx-w-logo">
                            <img alt="123" src="https://wieldy.g-axon.work/assets/images/logo.png" />
                        </Link>
                        <Link passHref href="/" className="gx-d-none gx-d-lg-block gx-pointer gx-mr-xs-5 gx-logo">
                            <img alt="123" src="https://wieldy.g-axon.work/assets/images/logo.png" />
                        </Link>
